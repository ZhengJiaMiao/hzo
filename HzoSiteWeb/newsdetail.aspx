<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="newsdetail.aspx.cs" Inherits="HzoSiteWeb.newsdetail" %>
			...
			<div class="detail-box">
				<div class="w900">
					<div class="detail-tit">
						...
						<p class="subtitle"><span class="time"><%= DateTime.Parse(ds.Createtime.ToString()).ToString("yyyy-MM-dd") %></span><span class="leibie"><%=ds.Source %></span></p>
					</div>
		...
		<div class="detail-guess">
			<%--<div class="detail-guess-inner">
				<div class="column-hd clearfix">
					<h5 class="l">猜你喜欢 </h5><span class="l">/</span><a href="" class="l">更多</a>
				</div>
